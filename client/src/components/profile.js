            ...
            this.props.auth ? <div className="profile">
                ...
                <div className="userprof">
                    ...
                    <form className="userdetails" onSubmit={this.onUpdateUser}>
                        ...
                        <textarea value={this.state.updatedFeedback ? this.state.updatedFeedback : null} onChange={this.onChangeFeedback} placeholder="Please give us your valuable feedback!"></textarea>
                        <p className="colorize" style={{ textAlign: 'center' }}>{this.state.warning}</p>
                        <button className={this.changeDetect() ? 'udbactive' : 'udbdisabled'} style={{ pointerEvents: this.changeDetect() ? '' : 'none' }}>Update</button>
                    </form>
                </div>
            </div> :
