...
const MapWithAMarker = compose(withScriptjs, withGoogleMap)(props => {
    return (
        <GoogleMap defaultZoom={9} defaultCenter={props.defaults}>
                                ...
                                <div className="mapitem">
                                    ...
                                    <div className="mapitem-1">
                                        ...
                                        <div className="mapitem-1-1">
                                            ...
                                            {(marker.user._id !== props.user._id) && !props.alldonors && <p><FontAwesomeIcon icon={['fas', 'map-marker-alt']} style={{ color: '#b21e2e' }} /> {(getDistance({ lat: marker.location.coordinates[1], lng: marker.location.coordinates[0] }, props.defaults) / 1000).toFixed(2)} km Away</p>}
                                        </div>
                                    </div>
        ...
        return (
            <div style={{ marginTop: '2.5%' }}>
                <MapWithAMarker
                    ...
                    googleMapURL={"https://maps.googleapis.com/maps/api/js?key=AIzaSyBlUmInDBrZR37g8i33_JJMYs9-68oSHOs&libraries=geometry&libraries=places&callback=initMap"}
